...
public:
	...
	void wyswietlRekeKomputera1(sf::RenderWindow & window, const float x[6], const float y[2]);					//funkcja wyœwietlaj¹ca rêkê komputera w oknie - wersja dla pierwszej czêœci gry
	void wyswietlRekeCzlowieka1(sf::RenderWindow & window, const float x[6], const float y[2]);					//funkcja wyœwietlaj¹ca rêkê cz³owieka w oknie - wersja dla pierwszej czêœci gry
	void wyswietlRekeKomputera2(sf::RenderWindow & window, int tab[6], const float x[6], const float y[2]);		//funkcja wyœwietlaj¹ca rêkê komputera w oknie - wersja dla drugiej czêœci gry
	void wyswietlRekeCzlowieka2(sf::RenderWindow & window, int tab[6], const float x[6], const float y[2]);		//funkcja wyœwietlaj¹ca rêkê cz³owieka w oknie - wersja dla drugiej czêœci gry
};
