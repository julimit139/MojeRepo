...
const int wspolrzednaKoloruAtutowegoX = 519;
const int wspolrzednaKoloruAtutowegoY = 245;
const int wspolrzedneXWylozonychKart[2] = {444, 594};
//const int wspolrzednaPunktowX = 1058;
//const int wspolrzednePunktowY[2] = { 245, 375 };
